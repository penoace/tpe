                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="progress" id="progress">
                                <option value="open" <?= ($fdt['progress']=='open')?'selected':'' ?> >Open</option>
                                <option value="inprogress" <?= ($fdt['progress']=='inprogress')?'selected':'' ?>>Inprrogress</option>
                                <option value="close" <?= ($fdt['progress']=='close')?'selected':'' ?>>Close</option>
                            </select>
                        </div>
                        <div class="form-group">
